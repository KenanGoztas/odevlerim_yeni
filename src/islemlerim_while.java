...
public class islemlerim_while {
    public static void main(String[] args) {
        Scanner myScan = new Scanner(System.in);
        int secim = 0, sayi1= 0, sayi2= 0, sonuc, i;
        while (true) {
            sonuc = 0;
            System.out.println();
            ...
            System.out.println("4. toplayarak çarpma işlem");
        ...
        } //burada true olmasının anlamı ve sonuçları nelerdir bilmiyorum.
